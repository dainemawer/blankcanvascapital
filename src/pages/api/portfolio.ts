...
export default function handler(
	...
	res
		...
		.json([
			...
			{
				date: 'January 2024',
				hero: '/heros/vantage-emea-hero.jpg',
				logo: '/logos/vantage-data-centers.png',
				region: 'Europe, Middle East & Africa (EMEA)',
				sector: 'Data Centers',
				status: 'current',
				description: "Vantage Data Centers is a global leading owner, developer and operator of hyperscale data centers. BCC partnered with Advencap to raise a fund to invest into the Vantage EMEA business.",
				category: 'Private Equity',
				id: '35',
				title: 'Vantage Data Centers (EMEA)',
				url: 'http://vantage-dc.com',
				position: 'bottom',
			},
			{
