...
export default function handler(
	...
	res
		...
		.json([
			...
			{
				logo: '/logos/advencap-india.png',
				hero: '/heros/advencap-india.jpg',
				region: 'India',
				sector: 'Digital Infrastructure',
				date: 'September 2023',
				status: 'current',
				description: "Advencap Fibre Partnership has invested in a digital infrastructure business in India whereby its business builds, owns, and operates small cell, fiber, and (Fiber To The Home) FTTH infrastructure as a neutral wholesaler to telcos, ISPs, enterprises, and large content providers.",
				category: 'Private Equity',
				id: '1',
				url: 'http://www.advencap.com',
				title: 'Advencap India',
				position: 'center',
			},
			{
				region: 'South Africa',
